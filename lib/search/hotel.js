...
function find (params, callback) {
  ...
  var amenities = (params.has) ? isArray(params.has) ? params.has : [params.has] : params.has;
  var geo = (params.locatedIn) ? isArray(params.locatedIn) ? params.locatedIn : [params.locatedIn] : params.locatedIn;
