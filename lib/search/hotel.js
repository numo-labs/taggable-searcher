...
var lltrace = require('lltrace-aws-sdk').traceCustom;
...
function computeQueryFunctions (query, database) {
  // We are relying on the lambda that's using this library calling
  // lltrace.init in its handler. If it didn't, the diagram will have 'unknown'
  // as the caller:
  lltrace({ target: 'Neo', type: 'neo4j' });
