...
function search (text, options, cloudSearchDomain, callback) {
  var params = {
    query: computeQuery(text, options.market, options.language, options.operator, options.include, options.exclude),
...
module.exports.__search = search;
